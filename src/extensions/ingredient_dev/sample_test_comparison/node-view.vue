          ...
          <div style="padding: 6px 0;display: block;">
            <t-space>
              <div>
                ...
                <t-input v-if="false" v-model="_title" label="名称：" autofocus autoWidth borderless placeholder="请输入物料名称" />
              </div>
              <t-space>
                <t-button size="small" variant="outline" @click="addFunc">对比</t-button>
